window.onload = function() {
    const useNodeJS = false;   / you are not using a node server, set this value to fa
    const defaultLiffId = "1655642985-mxLd5PW9";   // change the default LIFF value if you are not using a node server
